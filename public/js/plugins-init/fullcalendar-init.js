    ...
    success: function (res) {
        !  function (e) {
            ...
            t.prototype.onDrop = function (t, n) {
                ...
                var o = this,
                    i = e("<form></form>");
                i.append("<label>Change event name</label>"), i.append("<div class='input-group'><input class='form-control' type=text value='" + t.title + "' disabled /</div>"), o.$modal.modal({
                    backdrop: "static"
