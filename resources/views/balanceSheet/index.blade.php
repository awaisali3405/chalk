                                        ...
                                        <table id="example5" class="display" style="min-width: 845px">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->feeDue(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        {{-- @dd(request()->get('branch_id'), request()->get('academic_year_id')) --}}
                                                        {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->depositReceived(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                    </td>
                                                    <td class="text-left">Suppliers</td>
                                                    <td class="text-left">
                                                        {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->supplierPurchase(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->depositDue(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        ...
                                                        {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->resourceFeeDue(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                    </td>
                                                    <td class="text-left">Deposit Refundables</td>
                                                    <td class="text-left">
                                                        {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->depositRefundable(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left">
                                                        ...
                                                        {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->resourceDue(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                    </td>
                                            ...
                                            <table id="example5" class="display" style="min-width: 500px">
                                                ...
                                                <tbody>
                                                    <tr class="border">
                                                        <td>Cash</td>
                                                        <td>
                                                            {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->depositRefundableByCash(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                        </td>
                                                        <td>
                                                            {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->depositRegistrationByCash(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                    ...
                                                    <tr class="border">
                                                        <td>Bank</td>
                                                        <td>
                                                            {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->depositRefundableByBank(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}

                                                        </td>
                                                        <td>

                                                            {{ !is_null(request()->get('branch_id')) && request()->get('academic_year_id')? auth()->user()->depositRegistrationByBank(request()->get('branch_id'), request()->get('academic_year_id')): 0 }}
                                                        </td>
                                                        <td>
