                                ...
                                <div class="custom-tab-1">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item"><a href="#about-me" data-toggle="tab"
                                                class="nav-link active show">Add Refund</a></li>
                                        <li class="nav-item"><a href="#receipt-list" data-toggle="tab"
                                                class="nav-link ">Refund List</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div id="about-me" class="tab-pane fade active show">
                                            <div class="profile-personal-info pt-4">
                                                {{-- <h4 class="text-primary mb-4">Personal Information</h4> --}}
                                                <form action="{{ route('invoice.refund.store', $invoice->id) }}"
                                                    method="post">
                                                    @csrf
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                                            <input type="hidden" name="invoice_id"
                                                                value="{{ $invoice->id }}">
                                                            <div class="form-group">
                                                                <label class="form-label">Refunding Amount</label>
                                                                <div class="input-group mb-2">
                                                                    <div class="input-group-prepend">
                                                                        <div class="input-group-text">£</div>
                                                                    </div>
                                                                    ...
                                                                    <input type="number" step="0.01"
                                                                        ...
                                                                        value="{{ $invoice->refundable() }}"
                                                                        max="{{ $invoice->refundable() }}" name="amount"
                                                                        required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group mb-2">
                                                                    <input type="text" class="form-control"
                                                                        name="description" value="Amount Refunded By"
                                                                        placeholder="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-2">
                                                            ...
                                                            <input type="text" value="{{ $invoice->refundable() }}"
                                                                id="total" class="form-control pay_amount"
                                                                placeholder="" readonly>
                                                        </div>
                                                    </div>
