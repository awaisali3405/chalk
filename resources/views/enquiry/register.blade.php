                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row enquiry-subject-list d-none">
                                                            <div class="col-12">
                                                                <h4>Enquiry Subject List</h4>
                                                                <ul>
                                                                    @foreach (json_decode($enquiry->subject) as $value)
                                                                        <li>{{ $value }}</li>
                                                                    @endforeach
                                                        ...
                                                        <div class="row pb-4">
                                                            <div class="col-12 d-flex justify-content-end">
                                                                <span class="btn btn-primary " id="veiw-enquiry-list">View
                                                                    Enquiry
                                                                    Subject</span>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="no_of_hr" id="hours"
                                                                        class="form-control">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 d-none">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" id="resource_discount" class="form-control"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-2">
                                                        ...
                                                        <input type="text" class="form-control fee-total"
                                                            value="0" name="total_fee" id="total_fee" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body " id="parent">
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-group">
                                                    <label for="" class="form-label">Selected
                                                        Parent</label>
                            ...
                            <div class="col-xl-6 col-xxl-6 col-sm-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title">Parent 2 /Guardian 2 Details
                                        </h5>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body " id="parent">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label class="form-label">Other Contact
                                                        Info</label>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-header d-flex justify-content-center">
                                        <h2>Disabilty, Medical Condition and behavioral Disorder
                                        </h2>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label class="form-label">Does the student
                                                        have disablilty, medical condition
                                                        and behavioural disorder which may
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <div class="form-check">
                                                                ...
                                                                <input type="radio" class="form-check-input"
                                                                    id="is_disorder_not" value="0"
                                                                    name="is_disable">
                                                                <label class="form-check-label"
                                                                    for="is_disorder_not">No</label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label class="form-label">If yes, please
                                                        specify:</label>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label class="form-label">How do you Know
                                                        About Us</label>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label class="form-label">Do you have any
                                                        comments or feedback?</label>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <input type="checkbox" name="" name="" id=""
                                                        required>
                                                    <label class="form-label pl-2">I consent
                                                        for my data to be stored in line with
                                                        the
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <label class="form-label pl-2">I accept
                                                        the terms & conditions. Read our T&Cs
                                                        here.
                                                    </label>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <input type="checkbox" name="" required>
                                                    <label class="form-label pl-2">I agree for
                                                        Chalk'n'Duster to contact me with
                                                        details of their services.
                                                        We will send you info about our tutoring
                                                        services. Of course you can opt out
                                                        at any time.
                                                    </label>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <label class="form-label pl-2">I consent
                                                        to any necessary emergency treatment
                                                        whilst my child is attending the course
                                                        and authorize the staff to sign any
                                                        form of
                                                        consent required by medical staff if a
                                                        delay in obtaining my signature could
