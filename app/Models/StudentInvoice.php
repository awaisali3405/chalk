...
class StudentInvoice extends Model
{
    ...
    {
        return ($this->amount - (($this->receipt->sum('discount') + $this->receipt->sum('credit_discount') + $this->refunded_discount) - $this->receipt->sum('late_fee'))) - $this->receipt->sum('amount') >= 0 ? ($this->amount - (($this->receipt->sum('discount') + $this->receipt->sum('credit_discount') + $this->refunded_discount) - $this->receipt->sum('late_fee'))) - $this->receipt->sum('amount') : 0;
    }
